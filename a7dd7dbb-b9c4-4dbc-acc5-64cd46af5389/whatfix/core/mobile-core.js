...
function downloadConfigFromCDN(savedSegmentConfigMap) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    segmentationBaseUrl = "".concat(configBaseUrl, "/").concat(appApiKey).concat(selfHostingEndPoints.SELF_HOSTING, "/segmentation.json?v=").concat("185929");
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 6, , 7]);
                ...
                case 3:
                    ...
                    return [4, Promise.all(segmentationList.segments.map(function (segmentObject) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        configUrl = "".concat(configBaseUrl, "/").concat(appApiKey).concat(selfHostingEndPoints.SELF_HOSTING).concat(selfHostingEndPoints.SEGMENT_CONFIG_FOLDER).concat(segmentObject === null || segmentObject === void 0 ? void 0 : segmentObject.segmentId, ".json?v=").concat("185929");
...
function fetchConfig(_a, traceId) {
 ...
 console.log('config===>',"18:59:29",config);
                    if (!config) {
                        return [2];
                    }
                    _r.label = 2;
