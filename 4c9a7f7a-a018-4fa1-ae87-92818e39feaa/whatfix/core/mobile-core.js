/*! createdTime: Tue Jul 01 2025 12:32:22 GMT+0000 (Coordinated Universal Time) */
...
function initialiseConnectedProjectsParentObjectMap(project) {
    var _a;
    try {
        var projectId = (_a = project.projectParameters) === null || _a === void 0 ? void 0 : _a.projectId;
        ...
        if (project.connectedProjects && project.connectedProjects.length > 0 && projectId) {
            ...
            projectDetails_1.deploymentVersion = project.projectParameters.deploymentVersion;
            projectDetails_1.deploymentName = project.projectParameters.deploymentName;
            projectDetails_1.projectName = project.projectParameters.projectName;
        ...
        }, (error === null || error === void 0 ? void 0 : error.traceId) || undefined);
    }
}
...
function updateViewStatusForTheProject(key, traceId) {
    ...
    if (activeProject.id !== undefined) {
        ...
        if (key === "nSession" && initialTerminationStatus.nSession !== -1) {
            ...
            if (((_b = (_a = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _a === void 0 ? void 0 : _a.initialTerminationStatus) === null || _b === void 0 ? void 0 : _b.nSession) !== -1 &&
                ((_d = (_c = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _c === void 0 ? void 0 : _c.terminationStatus) === null || _d === void 0 ? void 0 : _d.nSession) === ((_f = (_e = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _e === void 0 ? void 0 : _e.initialTerminationStatus) === null || _f === void 0 ? void 0 : _f.nSession)) {
                sendAnalyticEvent(ANALYTICS_EVENTS.PROJECT_TERMINATION, {
                    terminationRule: "nSession: ".concat((_g = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project === null || project === void 0 ? void 0 : project.id]) === null || _g === void 0 ? void 0 : _g.initialTerminationStatus.nSession),
                }, traceId);
            }
        }
...
function runDetectionLogicForProjects(searchOnlyFlowMenu, webIdentifiers, traceId) {
    ...
    var projectFound = (_a = embedProject
        ...
        if (((_e = (_d = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _d === void 0 ? void 0 : _d.initialTerminationStatus) === null || _e === void 0 ? void 0 : _e.nSession) !==
            ...
            sendAnalyticEvent(ANALYTICS_EVENTS.PROJECT_TERMINATION, {
                terminationRule: "nSession: ".concat((_l = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project === null || project === void 0 ? void 0 : project.id]) === null || _l === void 0 ? void 0 : _l.initialTerminationStatus.nSession),
            }, traceId);
            removeProjectFromStatusArray({ id: project === null || project === void 0 ? void 0 : project.id });
            return false;
        }
        else if ((((_o = (_m = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _m === void 0 ? void 0 : _m.initialTerminationStatus) === null || _o === void 0 ? void 0 : _o.nDismissedByUser) !== -1 &&
            ((_q = (_p = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _p === void 0 ? void 0 : _p.terminationStatus) === null || _q === void 0 ? void 0 : _q.nDismissedByUser) === 1) ||
            (((_s = (_r = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _r === void 0 ? void 0 : _r.initialTerminationStatus) === null || _s === void 0 ? void 0 : _s.perApp) !== -1 &&
                ((_u = (_t = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _t === void 0 ? void 0 : _t.terminationStatus) === null || _u === void 0 ? void 0 : _u.perApp) === ((_w = (_v = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _v === void 0 ? void 0 : _v.initialTerminationStatus) === null || _w === void 0 ? void 0 : _w.perApp)) ||
            (((_y = (_x = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _x === void 0 ? void 0 : _x.initialTerminationStatus) === null || _y === void 0 ? void 0 : _y.untilAllFlowsAreCompleted) &&
                ((_0 = (_z = allProjectStatus === null || allProjectStatus === void 0 ? void 0 : allProjectStatus[project.id]) === null || _z === void 0 ? void 0 : _z.terminationStatus) === null || _0 === void 0 ? void 0 : _0.untilAllFlowsAreCompleted))) {
        ...
        switch (true) {
            ...
            case project.isAFlowMenu: {
                ...
                if (found &&
                    (((!((_1 = allProjectStatus[project === null || project === void 0 ? void 0 : project.id]) === null || _1 === void 0 ? void 0 : _1.isShown) ||
                        !((_2 = allProjectStatus[project === null || project === void 0 ? void 0 : project.id]) === null || _2 === void 0 ? void 0 : _2.isCompleted) ||
            ...
            case !project.isWebView: {
                ...
                if (found &&
                    ...
                    (!((_3 = allProjectStatus[project.id]) === null || _3 === void 0 ? void 0 : _3.isShown) ||
                        !((_4 = allProjectStatus[project.id]) === null || _4 === void 0 ? void 0 : _4.isCompleted)) &&
        ...
        if (lastStep.completionStep) {
            ...
            if (currentlyRunningFlow.id !== "") {
                ...
                if (areAllProjectsCompleted(currentRunningFlow)) {
                    if (allProjectStatus[activeProjectId].triggerCase ===
                        "EVERY_SESSION_UNTIL_ALL_FLOWS_ARE_COMPLETED") {
                        updateProjectStatus({ id: activeProjectId, isFlowTriggered: true }, traceId);
                    }
...
function createIfElseStatement(id, webIdentifier, webViewBounds, webViewScale, webviewUUID) {
    ...
    var condition = "".concat(querySelectorAllStatement);
    if (webIdentifier["innerText"] !== undefined &&
        webIdentifier["innerText"]["ang"] !== undefined) {
        var expectedText = JSON.stringify(webIdentifier["innerText"]["ang"]);
        condition += " && ".concat(querySelectorAllStatement, ".innerText === ").concat(expectedText);
    }
...
function downloadConfigFromCDN(savedSegmentConfigMap) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    segmentationBaseUrl = "".concat(configBaseUrl, "/").concat(appApiKey).concat(selfHostingEndPoints.SELF_HOSTING, "/segmentation.json?v=").concat("192615");
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 6, , 7]);
                ...
                case 3:
                    ...
                    return [4, Promise.all(segmentationList.segments.map(function (segmentObject) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        configUrl = "".concat(configBaseUrl, "/").concat(appApiKey).concat(selfHostingEndPoints.SELF_HOSTING).concat(selfHostingEndPoints.SEGMENT_CONFIG_FOLDER).concat(segmentObject === null || segmentObject === void 0 ? void 0 : segmentObject.segmentId, ".json?v=").concat("192615");
...
function fetchConfig(_a, traceId) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        var status, config, headers, requestBody, dataString, savedUserState, allUserProperties, customPropsDateObjects_1, keys, dateObjects, lastUpdatedAt, wfxProfileBody, response, _p, _q, wfxProfileProperties, error_3;
 ...
 console.log('config===>',"19:26:15",config);
                    if (!config) {
                        return [2];
                    }
                    _r.label = 2;
...
{}
                ...
                case 18:
                    error_3 = _r.sent();
                    console.error("fetchConfig(): failed to fetch config", error_3);
                    sendJSErrorObserverLog({
            ...
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve) {
                        ...
                        var processRequests = function () { return __awaiter(_this, void 0, void 0, function () {
                            var failedRequests, _a, retryBatchSize, getRetryBatchPayload, failedRequestsFromStorage, i, batch, batchedPayload, e_11, e_12;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
            ...
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) {
                        ...
                        var api = function () { return __awaiter(_this, void 0, void 0, function () {
                            var fetchRequestData, result, response, error_4;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 3, , 4]);
...
var surveyAnalyticsService = (function () {
        ...
        try {
            if ((body === null || body === void 0 ? void 0 : body.length) > 0) {
                ...
                sendJSErrorObserverLog({
                    ...
                    logData: {
                        projectIds: __spreadArray([], __read(projectIds_1), false),
                    },
                    error: error,
                });
            }
    ...
    function sendEvent(data) {
        ...
        var url = surveyEventsUrl || "".concat(appObserverBaseUrl, "service/survey/edith/api/v1/analytics/source/").concat(enterpriseId);
...
var eventCollectorService = {
    ...
    uploadNextBatch: function (traceId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, batch, responseUploadedStatus, error_5;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 5:
                        error_5 = _c.sent();
                        console.error("[".concat(traceId, "]Error uploading events"), error_5);
...
function handleLogsSentFromNative(data) {
    sendObserverLogs(__assign({ event_name: OBSERVER_EVENTS.SDK.ON_SDK_LOGGED, category: OBSERVER_EVENT_CATEGORIES.SDK }, data), generateUUID());
}
...
function setEnterpriseId() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!sdkStateService.entId) return [3, 2];
...
function fetchAndSetEnterpriseId(traceId) {
    return __awaiter(this, void 0, void 0, function () {
        var enterpriseId, jsMetadataResponse, error_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (isSelfHosted) {
                ...
                case 3:
                    error_10 = _a.sent();
                    console.error("Error fetching observer metadata", error_10);
                    sendJSErrorObserverLog({
                        logData: {
                            apikey: apiKey,
                            error: error_10
...
function fetchObserverMetadata(traceId) {
    return __awaiter(this, void 0, void 0, function () {
        var baseUrl, jsModuleHeaders, moduleResponse, error_11;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    error_11 = _a.sent();
                    console.error("fetchObserverMetadata(): unable to fetch observer metadata", error_11);
                    sendJSErrorObserverLog({
